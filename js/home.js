...
//     try {
//         currentPage++;
//         const moreListings = await fetchListings(currentPage);
...
// document.addEventListener('DOMContentLoaded', async () => {
//     try {
//         const initialListings = await getAllListings(currentPage);
...
//     return fetchListings(1); // Fetch the first page by default
// }
...
// document.getElementById("last-chance").addEventListener("click", () => {
//     sortListings(false, false, true).then((listings) => {
//         displayListings(listings);
//     });
// });
